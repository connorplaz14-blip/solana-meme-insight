...
export function PanelHeader({
  ...
  return (
    <div className="flex flex-col items-start gap-1.5 border-b border-border px-3 py-2 bg-panel-2/40 sm:flex-row sm:items-center sm:justify-between">
      ...
      {right ? <div className="flex items-center flex-wrap gap-2 text-[11px] text-muted-foreground w-full sm:w-auto sm:justify-end">{right}</div> : null}
    </div>
  );
}
